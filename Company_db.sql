...
CREATE TABLE Employee(
    ...
    Minitial char(1),
    Lname VARCHAR(50),
    employee_ssn  VARCHAR(30),
    Bdate varchar(30),
    Address varchar(100),
    Sex CHAR(1),
    Salary int,
    super_employee_ssn VARCHAR(30),
    dno INT,
...
CREATE TABLE WORKS_ON (
    ...
    FOREIGN KEY (Pno) REFERENCES Project(project_id)
);
...
CREATE TABLE DATEPART_location(
    Department_num INT,
    location VARCHAR(100),
    FOREIGN key(Department_num) REFERENCES  DEPARTMENT( DEPARTMENT_ID)
)
...
UPDATE employee SET dno = 5 WHERE employee_ssn = '333445555';
UPDATE employee SET dno = 4 WHERE employee_ssn = '987654321';
UPDATE employee SET dno = 1 WHERE employee_ssn = '888665555';
UPDATE employee SET dno = 6 WHERE employee_ssn = '111111100';
UPDATE employee SET dno = 7 WHERE employee_ssn = '444444400';
UPDATE employee SET dno = 6 WHERE employee_ssn = '555555500';
...
INSERT INTO DATEPART_location VALUES (1,'Houston');
INSERT INTO DATEPART_location VALUES (4,'Stafford');
INSERT INTO DATEPART_location VALUES (5,'Bellaire');
INSERT INTO DATEPART_location VALUES (5,'Sugarland');
INSERT INTO DATEPART_location VALUES (5,'Houston');
INSERT INTO DATEPART_location VALUES (6,'Atlanta');
INSERT INTO DATEPART_location VALUES (6,'Sacramento');
INSERT INTO DATEPART_location VALUES (7,'Milwaukee');
INSERT INTO DATEPART_location VALUES (8,'Chicago');
INSERT INTO DATEPART_location VALUES (8,'Dallas');
INSERT INTO DATEPART_location VALUES (8,'Philadephia');
INSERT INTO DATEPART_location VALUES (8,'Seattle');
INSERT INTO DATEPART_location VALUES (8,'Miami');

ALTER TABLE DEPARTMENT ADD FOREIGN KEY (MANAGER_ID) REFERENCES Employee(Employee_ssn);
